...
---@param availableCallback nil|fun(): boolean @Optional callback to check if feature is available.
---@param uiCallback nil|fun() @Optional callback to build options UI.
---@param closeCallback nil|fun(okClicked: boolean) @Optional callback to call to apply changes.
---@param flags ui.OnlineExtraFlags @Flags for specialized behaviour.
---@param toolFlags ui.WindowFlags? @Tool window flags (only with tool mode). Default value: `ImGuiWindowFlags_None`.
---@param toolSize vec2? @Default tool size (only with tool mode). Default value: `vec2(320, 400)`.
---@return ac.Disposable
...
---Calculate size of text using current IMGUI font.ac.Alignment
---@param text string
