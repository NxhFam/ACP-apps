...
---@param offset vec2? @Offset for an output of a given screen entity. Default value: `vec2(0, 0)`.
---@param scale vec2? @Scale for an output of a given screen entity. Default value: `vec2(1, 1)`.
...
---@param uvFrom vec2? @UV region, start (from 0 to 1). Default value: `vec2(0, 0)`.
---@param uvSize vec2? @UV region, end (from 0 to 1). Default value: `vec2(1, 1)`.
