...
---Adds force to a car body, invalidates current lap.
---@param torque vec3 @Force vector in N.
---@param torqueLocal boolean|`true`|`false` @If \`true\`, force is treated like vector relative to car coordinates, otherwise as world vector.
function ac.addTorque(torque, torqueLocal) end
...
---@param wheel integer
---@param value number
function ac.setRainTreadEfficiencyMultiplier(wheel, value) end
...
---@param newValue number
function ac.setDrivetrainRootVelocity(newValue) end

---Changes current drivetrain drive speed.
---@param newValue number
function ac.setDrivetrainDriveVelocity(newValue) end
...
function ac.shiftPatchTemperatures(tyre, targetTemperature, transfer) end
...
---@field enforceCustomInputScheme boolean
...
---@field controllerInputs number[] @8 items, starts with 0.
