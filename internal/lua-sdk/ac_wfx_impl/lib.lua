...
---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
---@return rgb
function ac.calculateSkyColor(v, includeSkyColor, includeMoonColor) end

---@param r rgb
---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
function ac.calculateSkyColorTo(r, v, includeSkyColor, includeMoonColor) end

---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
---@return rgb
function ac.calculateSkyColorV2(v, includeSkyColor, includeMoonColor) end

---@param r rgb
---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
function ac.calculateSkyColorV2To(r, v, includeSkyColor, includeMoonColor) end

---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
---@return rgb
function ac.calculateSkyColorNoGradients(v, includeSkyColor, includeMoonColor) end

---@param r rgb
---@param v vec3
---@param includeSkyColor boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
function ac.calculateSkyColorNoGradientsTo(r, v, includeSkyColor, includeMoonColor) end
...
---Note: currently, track callback is only called with main pass ID. Cloud shadows are also only called with
---main pass ID.
---@param sky render.PassID? @Default value: 0.
---@param clouds render.PassID? @Default value: 0.
---@param track render.PassID? @Default value: 0.
---@param cloudShadows render.PassID? @Default value: 0.
function ac.enableRenderCallback(sky, clouds, track, cloudShadows) end
