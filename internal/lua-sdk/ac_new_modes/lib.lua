...
---| `ac.CSPModuleID.NewModes` @New_modes.
...
---Is keyboard button just moved from not held to held.
---@param keyIndex ac.KeyIndex
---@return boolean
function ac.isKeyPressed(keyIndex) end

---Is keyboard button just moved from held to not held.
---@param keyIndex ac.KeyIndex
---@return boolean
...
---@param filename string @Full path to a file to monitor.
---@param callback fun() @Callback function.
---@return ac.Disposable
...
---Changes location of script storage. Available only for scripts with I/O access.
---@param relativePath string @Path relative to directory with Lua configs*/.
...
---Writes data into a file, returns `true` if operation was successfull. Data string can contain zero bytes.
---@param filename string
---@param data binary
---@return boolean
function io.save(filename, data) end

---Writes data into a file from a different thread, returns `true` via callback if operation was successfull. Data string can contain zero bytes.
---@param filename string
---@param data binary
...
---@field graphicsPitchRotation number @Graphics pitch rotation from car.ini
...
---@field screens ac.StateTripleItem[] @4 items, starts with 0.
...
---@param t table
---@param deep boolean|`true`|`false` @Set to `true` for deep cloning.
...
ac.CarAudioEventID = {
  ...
  Horn = 8, ---Value: 8.
  GearGrind = 9, ---Value: 9.
  BackfireExt = 10, ---Value: 10.
  BackfireInt = 11, ---Value: 11.
  TractionControlExt = 12, ---Value: 12.
  TractionControlInt = 13, ---Value: 13.
  Transmission = 14, ---Value: 14.
  Limiter = 15, ---Value: 15.
  Turbo = 16, ---Value: 16.
}
...
---| `render.ShadersType.Simplest` @Value: 16.
---| `render.ShadersType.SampleColor` @Value: 18.
---| `render.ShadersType.SampleNormal` @Value: 19.
---| `render.ShadersType.SampleEmissive` @Value: 20.
---| `render.ShadersType.Shadows` @Value: 27.
render.ShadersType = {
  Main = 0, ---Not recommended to use here.
  Simplified = 13, ---Value: 13.
  SimplifiedWithLights = 14, ---Value: 14.
  Simplest = 16, ---Value: 16.
  SampleColor = 18, ---Value: 18.
  SampleNormal = 19, ---Value: 19.
  SampleEmissive = 20, ---Value: 20.
  Shadows = 27, ---Value: 27.
}
...
ui.Icons = {
  AppWindow = 'APP_WINDOW', ---![Icon](https://acstuff.ru/images/icons_24/app_window.png)
  ...
  Attention = 'ATTENTION', ---![Icon](https://acstuff.ru/images/icons_24/attention.png)
  Avatar = 'AVATAR', ---![Icon](https://acstuff.ru/images/icons_24/avatar.png)
  ...
  Barcode = 'BARCODE', ---![Icon](https://acstuff.ru/images/icons_24/barcode.png)
  Bars = 'BARS', ---![Icon](https://acstuff.ru/images/icons_24/bars.png)
  BatteryEmpty = 'BATTERY_EMPTY', ---![Icon](https://acstuff.ru/images/icons_24/battery_empty.png)
  BatteryFull = 'BATTERY_FULL', ---![Icon](https://acstuff.ru/images/icons_24/battery_full.png)
  ...
  Binocoulars = 'BINOCOULARS', ---![Icon](https://acstuff.ru/images/icons_24/binocoulars.png)
  Blackboard = 'BLACKBOARD', ---![Icon](https://acstuff.ru/images/icons_24/blackboard.png)
  Bluetooth = 'BLUETOOTH', ---![Icon](https://acstuff.ru/images/icons_24/bluetooth.png)
  Bomb = 'BOMB', ---![Icon](https://acstuff.ru/images/icons_24/bomb.png)
  Book = 'BOOK', ---![Icon](https://acstuff.ru/images/icons_24/book.png)
  Bookmark = 'BOOKMARK', ---![Icon](https://acstuff.ru/images/icons_24/bookmark.png)
  Box = 'BOX', ---![Icon](https://acstuff.ru/images/icons_24/box.png)
  Briefcase = 'BRIEFCASE', ---![Icon](https://acstuff.ru/images/icons_24/briefcase.png)
  ...
  Calculator = 'CALCULATOR', ---![Icon](https://acstuff.ru/images/icons_24/calculator.png)
  Calendar = 'CALENDAR', ---![Icon](https://acstuff.ru/images/icons_24/calendar.png)
  ...
  Cards = 'CARDS', ---![Icon](https://acstuff.ru/images/icons_24/cards.png)
  Cctv = 'CCTV', ---![Icon](https://acstuff.ru/images/icons_24/cctv.png)
  Cellphone = 'CELLPHONE', ---![Icon](https://acstuff.ru/images/icons_24/cellphone.png)
  Chat = 'CHAT', ---![Icon](https://acstuff.ru/images/icons_24/chat.png)
  Clapperboard = 'CLAPPERBOARD', ---![Icon](https://acstuff.ru/images/icons_24/clapperboard.png)
  Clip = 'CLIP', ---![Icon](https://acstuff.ru/images/icons_24/clip.png)
  Clipboard = 'CLIPBOARD', ---![Icon](https://acstuff.ru/images/icons_24/clipboard.png)
  Clock = 'CLOCK', ---![Icon](https://acstuff.ru/images/icons_24/clock.png)
  Cloud = 'CLOUD', ---![Icon](https://acstuff.ru/images/icons_24/cloud.png)
  Code = 'CODE', ---![Icon](https://acstuff.ru/images/icons_24/code.png)
  Coffee = 'COFFEE', ---![Icon](https://acstuff.ru/images/icons_24/coffee.png)
  CompassAlt = 'COMPASS_ALT', ---![Icon](https://acstuff.ru/images/icons_24/compass_alt.png)
  ...
  Constellation = 'CONSTELLATION', ---![Icon](https://acstuff.ru/images/icons_24/constellation.png)
  Contacts = 'CONTACTS', ---![Icon](https://acstuff.ru/images/icons_24/contacts.png)
  Contrast = 'CONTRAST', ---![Icon](https://acstuff.ru/images/icons_24/contrast.png)
  Copy = 'COPY', ---![Icon](https://acstuff.ru/images/icons_24/copy.png)
  CreditCard = 'CREDIT_CARD', ---![Icon](https://acstuff.ru/images/icons_24/credit_card.png)
  Crop = 'CROP', ---![Icon](https://acstuff.ru/images/icons_24/crop.png)
  ...
  Directions = 'DIRECTIONS', ---![Icon](https://acstuff.ru/images/icons_24/directions.png)
  Document = 'DOCUMENT', ---![Icon](https://acstuff.ru/images/icons_24/document.png)
  DollarBill = 'DOLLAR_BILL', ---![Icon](https://acstuff.ru/images/icons_24/dollar_bill.png)
  ...
  Envelope = 'ENVELOPE', ---![Icon](https://acstuff.ru/images/icons_24/envelope.png)
  ...
  FilmRoll = 'FILM_ROLL', ---![Icon](https://acstuff.ru/images/icons_24/film_roll.png)
  Film = 'FILM', ---![Icon](https://acstuff.ru/images/icons_24/film.png)
  Finish = 'FINISH', ---![Icon](https://acstuff.ru/images/icons_24/finish.png)
  FireExtinguisher = 'FIRE_EXTINGUISHER', ---![Icon](https://acstuff.ru/images/icons_24/fire_extinguisher.png)
  Fireplace = 'FIREPLACE', ---![Icon](https://acstuff.ru/images/icons_24/fireplace.png)
  Flag = 'FLAG', ---![Icon](https://acstuff.ru/images/icons_24/flag.png)
  FM = 'FM', ---![Icon](https://acstuff.ru/images/icons_24/fm.png)
  Folder = 'FOLDER', ---![Icon](https://acstuff.ru/images/icons_24/folder.png)
  Font = 'FONT', ---![Icon](https://acstuff.ru/images/icons_24/font.png)
  Fuel = 'FUEL', ---![Icon](https://acstuff.ru/images/icons_24/fuel.png)
  Fullscreen = 'FULLSCREEN', ---![Icon](https://acstuff.ru/images/icons_24/fullscreen.png)
  Gamepad = 'GAMEPAD', ---![Icon](https://acstuff.ru/images/icons_24/gamepad.png)
  ...
  Headphones = 'HEADPHONES', ---![Icon](https://acstuff.ru/images/icons_24/headphones.png)
  HeartOutline = 'HEART_OUTLINE', ---![Icon](https://acstuff.ru/images/icons_24/heart_outline.png)
  Heart = 'HEART', ---![Icon](https://acstuff.ru/images/icons_24/heart.png)
  Hide = 'HIDE', ---![Icon](https://acstuff.ru/images/icons_24/hide.png)
  Home = 'HOME', ---![Icon](https://acstuff.ru/images/icons_24/home.png)
  Horizontal = 'HORIZONTAL', ---![Icon](https://acstuff.ru/images/icons_24/horizontal.png)
  Hourglass = 'HOURGLASS', ---![Icon](https://acstuff.ru/images/icons_24/hourglass.png)
  InboxEmpty = 'INBOX_EMPTY', ---![Icon](https://acstuff.ru/images/icons_24/inbox_empty.png)
  InboxFull = 'INBOX_FULL', ---![Icon](https://acstuff.ru/images/icons_24/inbox_full.png)
  Info = 'INFO', ---![Icon](https://acstuff.ru/images/icons_24/info.png)
  Key = 'KEY', ---![Icon](https://acstuff.ru/images/icons_24/key.png)
  Keyboard = 'KEYBOARD', ---![Icon](https://acstuff.ru/images/icons_24/keyboard.png)
  ...
  Laptop = 'LAPTOP', ---![Icon](https://acstuff.ru/images/icons_24/laptop.png)
  ...
  Levels = 'LEVELS', ---![Icon](https://acstuff.ru/images/icons_24/levels.png)
  LinkBroken = 'LINK_BROKEN', ---![Icon](https://acstuff.ru/images/icons_24/link_broken.png)
  Link = 'LINK', ---![Icon](https://acstuff.ru/images/icons_24/link.png)
  ListAlt = 'LIST_ALT', ---![Icon](https://acstuff.ru/images/icons_24/list_alt.png)
  List = 'LIST', ---![Icon](https://acstuff.ru/images/icons_24/list.png)
  ...
  Magnet = 'MAGNET', ---![Icon](https://acstuff.ru/images/icons_24/magnet.png)
  Map = 'MAP', ---![Icon](https://acstuff.ru/images/icons_24/map.png)
  Menu = 'MENU', ---![Icon](https://acstuff.ru/images/icons_24/menu.png)
  MicrophoneMuted = 'MICROPHONE_MUTED', ---![Icon](https://acstuff.ru/images/icons_24/microphone_muted.png)
  Microphone = 'MICROPHONE', ---![Icon](https://acstuff.ru/images/icons_24/microphone.png)
  ...
  Moon = 'MOON', ---![Icon](https://acstuff.ru/images/icons_24/moon.png)
  Mouse = 'MOUSE', ---![Icon](https://acstuff.ru/images/icons_24/mouse.png)
  ...
  PadlockUnlocked = 'PADLOCK_UNLOCKED', ---![Icon](https://acstuff.ru/images/icons_24/padlock_unlocked.png)
  Padlock = 'PADLOCK', ---![Icon](https://acstuff.ru/images/icons_24/padlock.png)
  Palette = 'PALETTE', ---![Icon](https://acstuff.ru/images/icons_24/palette.png)
  Paperclip = 'PAPERCLIP', ---![Icon](https://acstuff.ru/images/icons_24/paperclip.png)
  ...
  Person = 'PERSON', ---![Icon](https://acstuff.ru/images/icons_24/person.png)
  Photograph = 'PHOTOGRAPH', ---![Icon](https://acstuff.ru/images/icons_24/photograph.png)
  Pin = 'PIN', ---![Icon](https://acstuff.ru/images/icons_24/pin.png)
  PitStop = 'PIT_STOP', ---![Icon](https://acstuff.ru/images/icons_24/pit_stop.png)
  Plane = 'PLANE', ---![Icon](https://acstuff.ru/images/icons_24/plane.png)
  Play = 'PLAY', ---![Icon](https://acstuff.ru/images/icons_24/play.png)
  Plug = 'PLUG', ---![Icon](https://acstuff.ru/images/icons_24/plug.png)
  ...
  Puzzle = 'PUZZLE', ---![Icon](https://acstuff.ru/images/icons_24/puzzle.png)
  Python = 'PYTHON', ---![Icon](https://acstuff.ru/images/icons_24/python.png)
  QR = 'QR', ---![Icon](https://acstuff.ru/images/icons_24/qr.png)
  QuestionSign = 'QUESTION_SIGN', ---![Icon](https://acstuff.ru/images/icons_24/question_sign.png)
  Question = 'QUESTION', ---![Icon](https://acstuff.ru/images/icons_24/question.png)
  Radio = 'RADIO', ---![Icon](https://acstuff.ru/images/icons_24/radio.png)
  Recognition = 'RECOGNITION', ---![Icon](https://acstuff.ru/images/icons_24/recognition.png)
  ...
  Scissors = 'SCISSORS', ---![Icon](https://acstuff.ru/images/icons_24/scissors.png)
  ...
  SettingsAlt = 'SETTINGS_ALT', ---![Icon](https://acstuff.ru/images/icons_24/settings_alt.png)
  Settings = 'SETTINGS', ---![Icon](https://acstuff.ru/images/icons_24/settings.png)
  ShieldWithLock = 'SHIELD_WITH_LOCK', ---![Icon](https://acstuff.ru/images/icons_24/shield_with_lock.png)
  Shield = 'SHIELD', ---![Icon](https://acstuff.ru/images/icons_24/shield.png)
  ...
  Shopping = 'SHOPPING', ---![Icon](https://acstuff.ru/images/icons_24/shopping.png)
  Shuffle = 'SHUFFLE', ---![Icon](https://acstuff.ru/images/icons_24/shuffle.png)
  ...
  Spaceship = 'SPACESHIP', ---![Icon](https://acstuff.ru/images/icons_24/spaceship.png)
  Speaker = 'SPEAKER', ---![Icon](https://acstuff.ru/images/icons_24/speaker.png)
  ...
  SquaresHorizontal = 'SQUARES_HORIZONTAL', ---![Icon](https://acstuff.ru/images/icons_24/squares_horizontal.png)
  SquaresVertical = 'SQUARES_VERTICAL', ---![Icon](https://acstuff.ru/images/icons_24/squares_vertical.png)
  ...
  Stats = 'STATS', ---![Icon](https://acstuff.ru/images/icons_24/stats.png)
  ...
  Team = 'TEAM', ---![Icon](https://acstuff.ru/images/icons_24/team.png)
  Teleport = 'TELEPORT', ---![Icon](https://acstuff.ru/images/icons_24/teleport.png)
  Tent = 'TENT', ---![Icon](https://acstuff.ru/images/icons_24/tent.png)
  Thermometer = 'THERMOMETER', ---![Icon](https://acstuff.ru/images/icons_24/thermometer.png)
  ThumbDown = 'THUMB_DOWN', ---![Icon](https://acstuff.ru/images/icons_24/thumb_down.png)
  ThumbUp = 'THUMB_UP', ---![Icon](https://acstuff.ru/images/icons_24/thumb_up.png)
  TimeRewind = 'TIME_REWIND', ---![Icon](https://acstuff.ru/images/icons_24/time_rewind.png)
  ...
  Trash = 'TRASH', ---![Icon](https://acstuff.ru/images/icons_24/trash.png)
  Trophy = 'TROPHY', ---![Icon](https://acstuff.ru/images/icons_24/trophy.png)
  Tv = 'TV', ---![Icon](https://acstuff.ru/images/icons_24/tv.png)
  Umbrella = 'UMBRELLA', ---![Icon](https://acstuff.ru/images/icons_24/umbrella.png)
  Undo = 'UNDO', ---![Icon](https://acstuff.ru/images/icons_24/undo.png)
  Up = 'UP', ---![Icon](https://acstuff.ru/images/icons_24/up.png)
  User = 'USER', ---![Icon](https://acstuff.ru/images/icons_24/user.png)
  Verified = 'VERIFIED', ---![Icon](https://acstuff.ru/images/icons_24/verified.png)
  VideoCameraAlt = 'VIDEO_CAMERA_ALT', ---![Icon](https://acstuff.ru/images/icons_24/video_camera_alt.png)
  VideoCamera = 'VIDEO_CAMERA', ---![Icon](https://acstuff.ru/images/icons_24/video_camera.png)
  VIP = 'VIP', ---![Icon](https://acstuff.ru/images/icons_24/vip.png)
  ...
  Wallet = 'WALLET', ---![Icon](https://acstuff.ru/images/icons_24/wallet.png)
  ...
  Webcam = 'WEBCAM', ---![Icon](https://acstuff.ru/images/icons_24/webcam.png)
  ...
  ZoomIn = 'ZOOM_IN', ---![Icon](https://acstuff.ru/images/icons_24/zoom_in.png)
  ZoomOut = 'ZOOM_OUT', ---![Icon](https://acstuff.ru/images/icons_24/zoom_out.png)
}
...
---@overload fun(imageSource: ui.ImageSource, p1: vec2, p2: vec2, uv1: vec2, uv2: vec2, keepAspectRatio: boolean)
---@overload fun(imageSource: ui.ImageSource, p1: vec2, p2: vec2, keepAspectRatio: boolean)
---@param imageSource ui.ImageSource @Path to the image, absolute or relative to script folder or AC root. URLs are also accepted.
...
function ui.drawImage(imageSource, p1, p2, color, uv1, uv2, keepAspectRatio) end
...
---@param posMax vec2
---@param color rgbm? @Default value: `rgbm.colors.white`.
---@param alignment vec2? @Default value: `vec2(0, 0)`.
---@param ellipsis boolean? @Default value: `false`.
...
---@param pos vec2|nil @If not set, notification counter will be added to the previous element. Default value: `nil`.
...
---@param id string
---@param flags ui.WindowFlags? @Default value: 0.
---@return boolean
function ui.beginPopup(id, flags) end
...
---@overload fun(imageSource: ui.ImageSource, size: vec2, color: rgbm, keepAspectRatio: boolean)
---@overload fun(imageSource: ui.ImageSource, size: vec2, keepAspectRatio: boolean)
---@param imageSource ui.ImageSource @Path to the image, absolute or relative to script folder or AC root. URLs are also accepted.
...
---@param uv2 vec2? @Texture coordinates for bottom right corner. Default value: `vec2( 1, 1 )`.
---@param keepAspectRatio boolean? @Set to \`true\` to stretch image to fit given size, making sure it would not get distorted. Default value: `false`.
function ui.image(imageSource, size, color, borderColor, uv1, uv2, keepAspectRatio) end
...
---@overload fun(imageSource: ui.ImageSource, size: vec2, bgColor: rgbm, framePadding: number, keepAspectRatio: boolean)
---@overload fun(imageSource: ui.ImageSource, size: vec2, framePadding: number, keepAspectRatio: boolean)
...
---@param keepAspectRatio boolean? @Set to \`true\` to stretch image to fit given size, making sure it would not get distorted. Default value: `false`.
---@return boolean
function ui.imageButton(imageSource, size, bgColor, color, uv1, uv2, framePadding, keepAspectRatio) end
...
---Shows a hidden app window or few while current script is alive.
---@param appID string
...
---@return ac.Disposable
function ui.onDriverTooltip(callback) end
...
---Adds or subtracts time offset, useful for debugging. Only affects single-player races.
...
---@param photoelasticityBoost number? @Boost for glass photoelasticity effect, from 0 to 3. Default value: 1.
function ac.setCameraCPLSettings(intensity, rotation, offset, photoelasticityBoost) end
...
---Replace driver model with a custom one asyncronously. For method to work current and new driver models should have common skeleton.
---@param carIndex integer @0-based car index.
---@param data binary|nil @Use \`nil\` to restore original model. Default value: `nil`.
---@return boolean
...
---@param format ac.ScreenshotFormat? @Default value: 0.
---@param callback nil|fun(err: string)? @Default value: 0.
...
---Activates or deactivates automatic shifter for a car. Invalidates lap.
---@param carIndex integer @0-based car index.
---@param active boolean? @Default value: `true`.
...
function physics.disableCarCollisions(carIndex, disable) end
...
function ac.CarAudioTweak.setParameter(eventID, key, value) end
...
function ui.UserIconsLayer(priority) end

---Adds a new settings item in settings list in apps.
---@param params {iconID: ui.Icons, name: string, size: {default: vec2, min: vec2, max: vec2}}|"{\n  iconID = ui.Icons.Settings,\n  name = '',\n  size = {\n    default = vec2(),\n    min = vec2(),\n    max = vec2()\n  }\n}" "Table with properties:\n- `iconID` (`ui.Icons`): Settings icon.\n- `name` (`string`): Name of the settings item (name of a script by default).\n- `size` (`{default: vec2, min: vec2, max: vec2}`): Size settings. Default size: `vec2(320, 240)`, default min size: `vec2(40, 20)`."
...
---@param size vec2?
---@return boolean
function _ac_ControlButton:control(size) end
...
--[[ wfx_common/ac_weatherconditions.lua ]]
